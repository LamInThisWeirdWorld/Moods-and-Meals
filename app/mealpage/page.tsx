  ...
  return (
    <div className="flex h-full w-full flex-row justify-around bg-[#0E141C] px-25 py-15">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-row items-center gap-5">
          ...
          <div className="flex flex-col gap-0.5">
            ...
            <div className="font-jersey15 text-5xl text-white">Matcha</div>
          </div>
        </div>
        ...
        <div className="relative mt-5 flex flex-col gap-5">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 m-auto flex h-105 w-105 items-center justify-center">
      ...
      <div className="mt-10 ml-30 flex w-200 flex-col gap-4">
        ...
        <div className="flex h-15 flex-row justify-between rounded-full bg-[#8AA7BC] pr-5 pl-5">
          {/* weather */}
